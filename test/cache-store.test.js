...
test('planEviction: 容量以内且不超龄时一个都不删', () => {
    const plan = cs.planEviction([e('a', 10, 1), e('b', 20, 2)], {
...
test('planEviction: 超龄条目一律淘汰，即使总量没超', () => {
    const plan = cs.planEviction([e('old', 1, 200), e('fresh', 1, 1)], {
...
test('planEviction: 年龄与容量叠加时不重复计算同一条目', () => {
    ...
    const plan = cs.planEviction(entries, {
